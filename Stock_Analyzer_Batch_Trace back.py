...
# 使用者可能還是想知道它實際表現如何）。
PINNED_COMBOS = [
    ["布林通道低檔(≤20%)", "爆量(≥1.5倍均量)", "晨星剛形成"],  # n=52，5日84.6%，10日84.6%，20日88.5%
    ["布林通道低檔(≤20%)", "近3月均價YoY為負", "晨星剛形成"],  # n=91，5日83.5%，10日84.6%，20日85.7%
    ["布林通道低檔(≤20%)", "近3月乖離度為正(營收優於股價)", "晨星剛形成"],  # n=116，5日81.0%，10日81.9%，20日80.2%
    ["布林通道低檔(≤20%)", "KDJ近3日內黃金交叉", "晨星剛形成"],  # n=177，5日78.5%，10日81.9%，20日75.1%
    ["布林通道低檔(≤20%)", "相對強弱為負(弱於大盤)", "晨星剛形成"],  # n=177，5日78.0%，10日80.8%，20日77.4%
    ["布林通道低檔(≤20%)", "三大法人近3月買超", "晨星剛形成"],  # n=109，5日76.1%，10日78.9%，20日71.3%
    ["布林通道低檔(≤20%)", "晨星剛形成"],  # n=203，5日75.9%，10日78.3%，20日73.4%
    ["布林通道低檔(≤20%)", "三大法人近3月賣超", "晨星剛形成"],  # n=94，5日75.5%，10日77.7%，20日75.2%
    ["布林通道低檔(≤20%)", "相對強弱為正(強於大盤)", "爆量(≥2倍均量)"],  # n=735，5日73.1%，10日66.1%，20日69.5%
    ["布林通道低檔(≤20%)", "近3月均價YoY為正", "晨星剛形成"],  # n=112，5日69.6%，10日73.2%
    ["布林通道低檔(≤20%)", "近3月乖離度為負(股價超前營收)", "晨星剛形成"],  # n=85，5日69.4%，10日74.1%，20日64.7%
    ["布林通道低檔(≤20%)", "相對強弱為正(強於大盤)", "爆量(≥1.5倍均量)"],  # n=1560，5日66.3%，20日64.5%
    ["KDJ近3日內黃金交叉", "相對強弱為負(弱於大盤)", "晨星剛形成"],  # n=532，5日64.8%，10日66.4%
    ["相對強弱為負(弱於大盤)", "近3月均價YoY為負", "晨星剛形成"],  # n=214，5日65.9%，20日64.5%
    ["KDJ近3日內死亡交叉", "N字底剛形成", "一字底(均線糾結)剛形成"],  # n=84，10日66.7%，20日64.3%
    ["回後買上漲全通過", "一字底(均線糾結)剛形成", "突破飆股大量黑K最高點剛形成"],  # n=96，10日64.6%
    ["近3月乖離度為負(股價超前營收)", "N字底剛形成", "一字底(均線糾結)剛形成"],  # n=111，10日64.9%，20日64.0%
    ["MACD近3日內黃金交叉", "近3月乖離度為負(股價超前營收)", "母子懷抱(低檔)剛形成"],  # n=86，10日64.0%
    ["布林通道低檔(≤20%)", "爆量(≥2倍均量)", "型態剛形成(剛突破)"],  # n=62，5日67.7%
    ["布林通道低檔(≤20%)", "爆量(≥1.5倍均量)", "型態剛形成(剛突破)"],  # n=141，20日64.5%
    ["KDJ近3日內黃金交叉", "N字底剛形成", "一字底(均線糾結)剛形成"],  # n=127，20日64.6%
    ["近3月均價YoY為正", "N字底剛形成", "一字底(均線糾結)剛形成"],  # n=154，20日66.9%
    ["布林通道低檔(≤20%)", "近3月均價YoY為正", "夜星剛形成"],  # n=58，5日69.0%
    ["布林通道低檔(≤20%)", "爆量(≥2倍均量)", "型態突破確認"],  # n=64，5日65.6%
]


PINNED_COMBO_WINRATES = {
    "布林通道低檔(≤20%) ＋ 爆量(≥1.5倍均量) ＋ 晨星剛形成": { 5: 84.6, 10: 84.6, 20: 88.5 },
    "布林通道低檔(≤20%) ＋ 近3月均價YoY為負 ＋ 晨星剛形成": { 5: 83.5, 10: 84.6, 20: 85.7 },
    "布林通道低檔(≤20%) ＋ 近3月乖離度為正(營收優於股價) ＋ 晨星剛形成": { 5: 81.0, 10: 81.9, 20: 80.2 },
    "布林通道低檔(≤20%) ＋ KDJ近3日內黃金交叉 ＋ 晨星剛形成": { 5: 78.5, 10: 81.9, 20: 75.1 },
    "布林通道低檔(≤20%) ＋ 相對強弱為負(弱於大盤) ＋ 晨星剛形成": { 5: 78.0, 10: 80.8, 20: 77.4 },
    "布林通道低檔(≤20%) ＋ 三大法人近3月買超 ＋ 晨星剛形成": { 5: 76.1, 10: 78.9, 20: 71.3 },
    "布林通道低檔(≤20%) ＋ 晨星剛形成": { 5: 75.9, 10: 78.3, 20: 73.4 },
    "布林通道低檔(≤20%) ＋ 三大法人近3月賣超 ＋ 晨星剛形成": { 5: 75.5, 10: 77.7, 20: 75.2 },
    "布林通道低檔(≤20%) ＋ 相對強弱為正(強於大盤) ＋ 爆量(≥2倍均量)": { 5: 73.1, 10: 66.1, 20: 69.5 },
    "布林通道低檔(≤20%) ＋ 近3月均價YoY為正 ＋ 晨星剛形成": { 5: 69.6, 10: 73.2 },
    "布林通道低檔(≤20%) ＋ 近3月乖離度為負(股價超前營收) ＋ 晨星剛形成": { 5: 69.4, 10: 74.1, 20: 64.7 },
    "布林通道低檔(≤20%) ＋ 相對強弱為正(強於大盤) ＋ 爆量(≥1.5倍均量)": { 5: 66.3, 20: 64.5 },
    "KDJ近3日內黃金交叉 ＋ 相對強弱為負(弱於大盤) ＋ 晨星剛形成": { 5: 64.8, 10: 66.4 },
    "相對強弱為負(弱於大盤) ＋ 近3月均價YoY為負 ＋ 晨星剛形成": { 5: 65.9, 20: 64.5 },
    "KDJ近3日內死亡交叉 ＋ N字底剛形成 ＋ 一字底(均線糾結)剛形成": { 10: 66.7, 20: 64.3 },
    "回後買上漲全通過 ＋ 一字底(均線糾結)剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: 64.6 },
    "近3月乖離度為負(股價超前營收) ＋ N字底剛形成 ＋ 一字底(均線糾結)剛形成": { 10: 64.9, 20: 64.0 },
    "MACD近3日內黃金交叉 ＋ 近3月乖離度為負(股價超前營收) ＋ 母子懷抱(低檔)剛形成": { 10: 64.0 },
    "布林通道低檔(≤20%) ＋ 爆量(≥2倍均量) ＋ 型態剛形成(剛突破)": { 5: 67.7 },
    "布林通道低檔(≤20%) ＋ 爆量(≥1.5倍均量) ＋ 型態剛形成(剛突破)": { 20: 64.5 },
    "KDJ近3日內黃金交叉 ＋ N字底剛形成 ＋ 一字底(均線糾結)剛形成": { 20: 64.6 },
    "近3月均價YoY為正 ＋ N字底剛形成 ＋ 一字底(均線糾結)剛形成": { 20: 66.9 },
    "布林通道低檔(≤20%) ＋ 近3月均價YoY為正 ＋ 夜星剛形成": { 5: 69.0 },
    "布林通道低檔(≤20%) ＋ 爆量(≥2倍均量) ＋ 型態突破確認": { 5: 65.6 },
}
...
MOONSHOT_COMBOS = [
    ...
    ["近3月乖離度為正(營收優於股價)", "N字底剛形成", "一字底(均線糾結)剛形成"],
    ["爆量(≥1.5倍均量)", "N字底剛形成", "突破ABC修正下降切線剛形成"],
    ["近3月乖離度為負(股價超前營收)", "突破飆股大量黑K最高點剛形成", "N字底剛形成"],
...
MOONSHOT_COMBO_STATS = {
    "多方力道≥65 ＋ N字底剛形成 ＋ 突破ABC修正下降切線剛形成": { 10: {"n": 29, "moonshot_n": 5, "pct": 17.2, "avg": 42.5} },
    "強勢突破盤 ＋ N字底剛形成 ＋ 突破ABC修正下降切線剛形成": { 10: {"n": 25, "moonshot_n": 4, "pct": 16.0, "avg": 43.9} },
    "近3月乖離度為負(股價超前營收) ＋ 突破飆股大量黑K最高點剛形成 ＋ 晨星剛形成": { 10: {"n": 59, "moonshot_n": 9, "pct": 15.3, "avg": 41.2}, 20: {"n": 59, "moonshot_n": 16, "pct": 27.1, "avg": 53.9} },
    "近3月均價YoY為負 ＋ N字底剛形成 ＋ 突破ABC修正下降切線剛形成": { 10: {"n": 27, "moonshot_n": 4, "pct": 14.8, "avg": 37.0} },
    "三大法人近3月賣超 ＋ N字底剛形成 ＋ 突破ABC修正下降切線剛形成": { 10: {"n": 34, "moonshot_n": 5, "pct": 14.7, "avg": 38.2} },
    "相對強弱為負(弱於大盤) ＋ N字底剛形成 ＋ 突破ABC修正下降切線剛形成": { 10: {"n": 21, "moonshot_n": 3, "pct": 14.3, "avg": 36.4} },
    "突破飆股大量黑K最高點剛形成 ＋ K線橫盤的突破剛形成 ＋ 母子懷抱(低檔)剛形成": { 10: {"n": 23, "moonshot_n": 3, "pct": 13.0, "avg": 38.9}, 20: {"n": 23, "moonshot_n": 7, "pct": 30.4, "avg": 47.0} },
    "近3月乖離度為負(股價超前營收) ＋ 突破飆股大量黑K最高點剛形成 ＋ 母子懷抱(低檔)剛形成": { 10: {"n": 39, "moonshot_n": 5, "pct": 12.8, "avg": 40.1}, 20: {"n": 39, "moonshot_n": 9, "pct": 23.1, "avg": 51.1} },
    "KDJ近3日內黃金交叉 ＋ N字底剛形成 ＋ 突破ABC修正下降切線剛形成": { 10: {"n": 40, "moonshot_n": 5, "pct": 12.5, "avg": 38.7} },
    "爆量(≥2倍均量) ＋ N字底剛形成 ＋ 突破ABC修正下降切線剛形成": { 10: {"n": 33, "moonshot_n": 4, "pct": 12.1, "avg": 36.1} },
    "強勢突破盤 ＋ N字底剛形成 ＋ 晨星剛形成": { 10: {"n": 25, "moonshot_n": 3, "pct": 12.0, "avg": 42.7} },
    "KDJ近3日內死亡交叉 ＋ 突破飆股大量黑K最高點剛形成 ＋ 母子懷抱(低檔)剛形成": { 10: {"n": 25, "moonshot_n": 3, "pct": 12.0, "avg": 37.8} },
    "近3月均價YoY為正 ＋ 突破飆股大量黑K最高點剛形成 ＋ 晨星剛形成": { 10: {"n": 68, "moonshot_n": 8, "pct": 11.8, "avg": 42.5}, 20: {"n": 35, "moonshot_n": 8, "pct": 22.9, "avg": 46.7} },
    "突破飆股大量黑K最高點剛形成 ＋ 母子懷抱(低檔)剛形成 ＋ 晨星剛形成": { 10: {"n": 52, "moonshot_n": 6, "pct": 11.5, "avg": 38.9}, 20: {"n": 52, "moonshot_n": 13, "pct": 25.0, "avg": 46.7} },
    "近3月乖離度為正(營收優於股價) ＋ N字底剛形成 ＋ 一字底(均線糾結)剛形成": { 10: {"n": 35, "moonshot_n": 4, "pct": 11.4, "avg": 37.0} },
    "爆量(≥1.5倍均量) ＋ N字底剛形成 ＋ 突破ABC修正下降切線剛形成": { 10: {"n": 45, "moonshot_n": 5, "pct": 11.1, "avg": 37.4} },
    "近3月乖離度為負(股價超前營收) ＋ 突破飆股大量黑K最高點剛形成 ＋ N字底剛形成": { 10: {"n": 29, "moonshot_n": 3, "pct": 10.3, "avg": 47.9} },
    "近3月均價YoY為正 ＋ 突破飆股大量黑K最高點剛形成 ＋ 母子懷抱(低檔)剛形成": { 10: {"n": 39, "moonshot_n": 4, "pct": 10.3, "avg": 41.0} },
    "多方力道≥80 ＋ 突破ABC修正下降切線剛形成 ＋ 晨星剛形成": { 10: {"n": 30, "moonshot_n": 3, "pct": 10.0, "avg": 35.7} },
    "多方力道≥80 ＋ 突破飆股大量黑K最高點剛形成 ＋ 晨星剛形成": { 10: {"n": 60, "moonshot_n": 6, "pct": 10.0, "avg": 42.2} },
    "三大法人近3月買超 ＋ 突破飆股大量黑K最高點剛形成 ＋ 母子懷抱(低檔)剛形成": { 20: {"n": 20, "moonshot_n": 5, "pct": 25.0, "avg": 51.6} },
    "突破ABC修正下降切線剛形成 ＋ 突破飆股大量黑K最高點剛形成 ＋ 晨星剛形成": { 20: {"n": 24, "moonshot_n": 6, "pct": 25.0, "avg": 40.0} },
    "多方力道≥65 ＋ 三重底剛形成 ＋ 晨星剛形成": { 20: {"n": 21, "moonshot_n": 5, "pct": 23.8, "avg": 53.6} },
    "三大法人近3月買超 ＋ 圓弧底剛形成 ＋ 母子懷抱(低檔)剛形成": { 20: {"n": 27, "moonshot_n": 6, "pct": 22.2, "avg": 51.8} },
    "KDJ近3日內死亡交叉 ＋ K線橫盤的突破剛形成 ＋ 母子懷抱(低檔)剛形成": { 20: {"n": 23, "moonshot_n": 5, "pct": 21.7, "avg": 46.1} },
    "三大法人近3月賣超 ＋ 突破飆股大量黑K最高點剛形成 ＋ 晨星剛形成": { 20: {"n": 43, "moonshot_n": 9, "pct": 20.9, "avg": 63.6} },
    "MACD近3日內黃金交叉 ＋ K線橫盤的突破剛形成 ＋ 晨星剛形成": { 20: {"n": 36, "moonshot_n": 7, "pct": 19.4, "avg": 38.1} },
    "突破飆股大量黑K最高點剛形成 ＋ 晨星剛形成": { 20: {"n": 133, "moonshot_n": 25, "pct": 18.8, "avg": 53.9} },
    "KDJ近3日內黃金交叉 ＋ 突破飆股大量黑K最高點剛形成 ＋ 母子懷抱(低檔)剛形成": { 20: {"n": 32, "moonshot_n": 6, "pct": 18.8, "avg": 47.5} },
    "爆量(≥2倍均量) ＋ 突破飆股大量黑K最高點剛形成 ＋ 母子懷抱(低檔)剛形成": { 20: {"n": 48, "moonshot_n": 9, "pct": 18.8, "avg": 50.2} },
}
