...
# ── 相對強弱（vs 大盤）：用0050（元大台灣50）當大盤代理，不用另外接指數API，
...
def compute_relative_strength(data, benchmark, lookback: int = 20):
    ...
    跟其他「近20日」類指標（流動性門檻、vm20量比）的天數一致，方便橫向比較。"""
...
def run_historical_backtest(token: str, months_back: int = 3, include_pattern: bool = True,
    ...
    # 相對強弱要用的大盤(0050)資料，整個回測只抓一次，不是每檔股票各抓一次
    try:
...
# 使用者可能還是想知道它實際表現如何）。
PINNED_COMBOS = [
    ["布林通道低檔(≤20%)", "相對強弱為正(強於大盤)", "爆量(≥2倍均量)"],  # 5日79.5%
    ["布林通道低檔(≤20%)", "相對強弱為正(強於大盤)", "爆量(≥1.5倍均量)"],  # 5日71.4%
    ["多方力道≥65", "KDJ近3日內死亡交叉", "一字底(均線糾結)剛形成"],  # 5日60.4%，10日69.8%
    ["KDJ近3日內死亡交叉", "近3月均價YoY為正", "一字底(均線糾結)剛形成"],  # 10日67.9%，20日58.5%
    ["KDJ近3日內黃金交叉", "近3月乖離度為負(股價超前營收)", "晨星剛形成"],  # 5日64.4%，10日67.3%，20日64.4%
    ["KDJ近3日內死亡交叉", "三大法人近3月買超", "一字底(均線糾結)剛形成"],  # 10日65.4%
    ["KDJ近3日內黃金交叉", "三大法人近3月賣超", "晨星剛形成"],  # 5日65.2%，10日64.4%，20日63.3%
    ["強勢突破盤", "KDJ近3日內死亡交叉", "一字底(均線糾結)剛形成"],  # 10日65.0%
    ["近3月乖離度為負(股價超前營收)", "母子懷抱(低檔)剛形成", "晨星剛形成"],  # 20日64.8%
    ["KDJ近3日內黃金交叉", "三大法人近3月賣超", "母子懷抱(低檔)剛形成"],  # 20日64.4%
    ["KDJ近3日內死亡交叉", "近3月乖離度為負(股價超前營收)", "一字底(均線糾結)剛形成"],  # 10日63.8%
    ["KDJ近3日內黃金交叉", "近3月均價YoY為正", "晨星剛形成"],  # 5日61.2%，10日62.9%，20日60.3%
    ["KDJ近3日內黃金交叉", "晨星剛形成"],  # 5日60.3%，10日61.9%，20日58.7%
    ["KDJ近3日內黃金交叉", "型態剛形成(剛突破)", "晨星剛形成"],  # 5日60.3%，10日61.9%，20日58.7%
    ["KDJ近3日內黃金交叉", "型態成形中", "晨星剛形成"],  # 5日60.3%，10日61.9%，20日58.7%
    ["KDJ近3日內黃金交叉", "型態突破確認", "晨星剛形成"],  # 5日60.3%，10日61.9%，20日58.7%
    ["布林通道高檔(≥80%)", "KDJ近3日內死亡交叉", "一字底(均線糾結)剛形成"],  # 10日60.8%
    ["近3月乖離度為正(營收優於股價)", "三大法人近3月賣超", "晨星剛形成"],  # 5日60.6%，20日59.7%
    ["KDJ近3日內黃金交叉", "近3月均價YoY為負", "晨星剛形成"],  # 5日58.9%，10日60.3%
    ["KDJ近3日內死亡交叉", "三重底剛形成", "一字底(均線糾結)剛形成"],  # 10日60.3%
    ["KDJ近3日內黃金交叉", "三大法人近3月買超", "晨星剛形成"],  # 10日59.6%
    ["KDJ近3日內死亡交叉", "一字底(均線糾結)剛形成"],  # 10日59.2%
    ["KDJ近3日內死亡交叉", "型態突破確認", "一字底(均線糾結)剛形成"],  # 10日59.2%
    ["KDJ近3日內死亡交叉", "型態成形中", "一字底(均線糾結)剛形成"],  # 10日59.2%
    ["KDJ近3日內死亡交叉", "型態剛形成(剛突破)", "一字底(均線糾結)剛形成"],  # 10日59.2%
    ["布林通道低檔(≤20%)", "KDJ近3日內黃金交叉", "型態突破確認"],  # 20日59.0%
    ["布林通道低檔(≤20%)", "KDJ近3日內黃金交叉", "型態剛形成(剛突破)"],  # 20日58.8%
    ["KDJ近3日內黃金交叉", "母子懷抱(低檔)剛形成", "晨星剛形成"],  # 20日58.7%
    ["近3月均價YoY為正", "母子懷抱(低檔)剛形成", "晨星剛形成"],  # 20日58.7%
    ["近3月乖離度為負(股價超前營收)", "三大法人近3月買超", "晨星剛形成"],  # 5日58.7%
    ["強勢突破盤", "圓弧底剛形成", "突破飆股大量黑K最高點剛形成"],  # 20日58.5%
    ["型態成形中", "圓弧底剛形成", "突破飆股大量黑K最高點剛形成"],  # 20日58.3%
    ["型態剛形成(剛突破)", "圓弧底剛形成", "突破飆股大量黑K最高點剛形成"],  # 20日58.3%
    ["布林通道高檔(≥80%)", "圓弧底剛形成", "突破飆股大量黑K最高點剛形成"],  # 20日58.3%
    ["型態突破確認", "圓弧底剛形成", "突破飆股大量黑K最高點剛形成"],  # 20日58.3%
    ["爆量(≥1.5倍均量)", "晨星剛形成"],  # 5日58.2%
    ["爆量(≥1.5倍均量)", "型態剛形成(剛突破)", "晨星剛形成"],  # 5日58.2%
    ["爆量(≥1.5倍均量)", "型態突破確認", "晨星剛形成"],  # 5日58.2%
    ["爆量(≥1.5倍均量)", "型態成形中", "晨星剛形成"],  # 5日58.2%
...
PINNED_COMBO_WINRATES = {
    "布林通道低檔(≤20%) ＋ 相對強弱為正(強於大盤) ＋ 爆量(≥2倍均量)": { 5: 79.5 },
    "布林通道低檔(≤20%) ＋ 相對強弱為正(強於大盤) ＋ 爆量(≥1.5倍均量)": { 5: 71.4 },
    "多方力道≥65 ＋ KDJ近3日內死亡交叉 ＋ 一字底(均線糾結)剛形成": { 5: 60.4, 10: 69.8 },
    "KDJ近3日內死亡交叉 ＋ 近3月均價YoY為正 ＋ 一字底(均線糾結)剛形成": { 10: 67.9, 20: 58.5 },
    "KDJ近3日內黃金交叉 ＋ 近3月乖離度為負(股價超前營收) ＋ 晨星剛形成": { 5: 64.4, 10: 67.3, 20: 64.4 },
    "KDJ近3日內死亡交叉 ＋ 三大法人近3月買超 ＋ 一字底(均線糾結)剛形成": { 10: 65.4 },
    "KDJ近3日內黃金交叉 ＋ 三大法人近3月賣超 ＋ 晨星剛形成": { 5: 65.2, 10: 64.4, 20: 63.3 },
    "強勢突破盤 ＋ KDJ近3日內死亡交叉 ＋ 一字底(均線糾結)剛形成": { 10: 65.0 },
    "近3月乖離度為負(股價超前營收) ＋ 母子懷抱(低檔)剛形成 ＋ 晨星剛形成": { 20: 64.8 },
    "KDJ近3日內黃金交叉 ＋ 三大法人近3月賣超 ＋ 母子懷抱(低檔)剛形成": { 20: 64.4 },
    "KDJ近3日內死亡交叉 ＋ 近3月乖離度為負(股價超前營收) ＋ 一字底(均線糾結)剛形成": { 10: 63.8 },
    "KDJ近3日內黃金交叉 ＋ 近3月均價YoY為正 ＋ 晨星剛形成": { 5: 61.2, 10: 62.9, 20: 60.3 },
    "KDJ近3日內黃金交叉 ＋ 晨星剛形成": { 5: 60.3, 10: 61.9, 20: 58.7 },
    "KDJ近3日內黃金交叉 ＋ 型態剛形成(剛突破) ＋ 晨星剛形成": { 5: 60.3, 10: 61.9, 20: 58.7 },
    "KDJ近3日內黃金交叉 ＋ 型態成形中 ＋ 晨星剛形成": { 5: 60.3, 10: 61.9, 20: 58.7 },
    "KDJ近3日內黃金交叉 ＋ 型態突破確認 ＋ 晨星剛形成": { 5: 60.3, 10: 61.9, 20: 58.7 },
    "布林通道高檔(≥80%) ＋ KDJ近3日內死亡交叉 ＋ 一字底(均線糾結)剛形成": { 10: 60.8 },
    "近3月乖離度為正(營收優於股價) ＋ 三大法人近3月賣超 ＋ 晨星剛形成": { 5: 60.6, 20: 59.7 },
    "KDJ近3日內黃金交叉 ＋ 近3月均價YoY為負 ＋ 晨星剛形成": { 5: 58.9, 10: 60.3 },
    "KDJ近3日內死亡交叉 ＋ 三重底剛形成 ＋ 一字底(均線糾結)剛形成": { 10: 60.3 },
    "KDJ近3日內黃金交叉 ＋ 三大法人近3月買超 ＋ 晨星剛形成": { 10: 59.6 },
    "KDJ近3日內死亡交叉 ＋ 一字底(均線糾結)剛形成": { 10: 59.2 },
    "KDJ近3日內死亡交叉 ＋ 型態突破確認 ＋ 一字底(均線糾結)剛形成": { 10: 59.2 },
    "KDJ近3日內死亡交叉 ＋ 型態成形中 ＋ 一字底(均線糾結)剛形成": { 10: 59.2 },
    "KDJ近3日內死亡交叉 ＋ 型態剛形成(剛突破) ＋ 一字底(均線糾結)剛形成": { 10: 59.2 },
    "布林通道低檔(≤20%) ＋ KDJ近3日內黃金交叉 ＋ 型態突破確認": { 20: 59.0 },
    "布林通道低檔(≤20%) ＋ KDJ近3日內黃金交叉 ＋ 型態剛形成(剛突破)": { 20: 58.8 },
    "KDJ近3日內黃金交叉 ＋ 母子懷抱(低檔)剛形成 ＋ 晨星剛形成": { 20: 58.7 },
    "近3月均價YoY為正 ＋ 母子懷抱(低檔)剛形成 ＋ 晨星剛形成": { 20: 58.7 },
    "近3月乖離度為負(股價超前營收) ＋ 三大法人近3月買超 ＋ 晨星剛形成": { 5: 58.7 },
    "強勢突破盤 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 20: 58.5 },
    "型態成形中 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 20: 58.3 },
    "型態剛形成(剛突破) ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 20: 58.3 },
    "布林通道高檔(≥80%) ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 20: 58.3 },
    "型態突破確認 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 20: 58.3 },
    "爆量(≥1.5倍均量) ＋ 晨星剛形成": { 5: 58.2 },
    "爆量(≥1.5倍均量) ＋ 型態剛形成(剛突破) ＋ 晨星剛形成": { 5: 58.2 },
    "爆量(≥1.5倍均量) ＋ 型態突破確認 ＋ 晨星剛形成": { 5: 58.2 },
    "爆量(≥1.5倍均量) ＋ 型態成形中 ＋ 晨星剛形成": { 5: 58.2 },
...
MOONSHOT_COMBOS = [
    ...
    ["MACD近3日內黃金交叉", "一字底(均線糾結)剛形成", "突破ABC修正下降切線剛形成"],
...
MOONSHOT_COMBO_STATS = {
    "MACD近3日內黃金交叉 ＋ 近3月乖離度為負(股價超前營收) ＋ 夜星剛形成": { 20: {"n": 20, "moonshot_n": 5, "pct": 25.0, "avg": 59.8} },
    "三大法人近3月買超 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 20: {"n": 33, "moonshot_n": 7, "pct": 21.2, "avg": 56.5} },
    "近3月均價YoY為負 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 31, "moonshot_n": 4, "pct": 12.9, "avg": 42.3}, 20: {"n": 31, "moonshot_n": 6, "pct": 19.4, "avg": 58.0} },
    "回後買上漲全通過 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 20: {"n": 34, "moonshot_n": 6, "pct": 17.6, "avg": 62.7} },
    "近3月乖離度為正(營收優於股價) ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 29, "moonshot_n": 3, "pct": 10.3, "avg": 41.5}, 20: {"n": 29, "moonshot_n": 5, "pct": 17.2, "avg": 59.2} },
    "多方力道≥65 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 41, "moonshot_n": 4, "pct": 9.8, "avg": 39.4}, 20: {"n": 41, "moonshot_n": 7, "pct": 17.1, "avg": 55.7} },
    "強勢突破盤 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 53, "moonshot_n": 6, "pct": 11.3, "avg": 39.7}, 20: {"n": 53, "moonshot_n": 9, "pct": 17.0, "avg": 56.8} },
    "MACD近3日內黃金交叉 ＋ 一字底(均線糾結)剛形成 ＋ 突破ABC修正下降切線剛形成": { 5: {"n": 20, "moonshot_n": 2, "pct": 10.0, "avg": 35.8}, 10: {"n": 20, "moonshot_n": 3, "pct": 15.0, "avg": 53.3} },
    "型態突破確認 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 60, "moonshot_n": 6, "pct": 10.0, "avg": 39.7}, 20: {"n": 60, "moonshot_n": 9, "pct": 15.0, "avg": 56.8} },
    "布林通道高檔(≥80%) ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 60, "moonshot_n": 6, "pct": 10.0, "avg": 39.7}, 20: {"n": 60, "moonshot_n": 9, "pct": 15.0, "avg": 56.8} },
    "型態成形中 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 60, "moonshot_n": 6, "pct": 10.0, "avg": 39.7}, 20: {"n": 60, "moonshot_n": 9, "pct": 15.0, "avg": 56.8} },
    "圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 60, "moonshot_n": 6, "pct": 10.0, "avg": 39.7}, 20: {"n": 60, "moonshot_n": 9, "pct": 15.0, "avg": 56.8} },
    "型態剛形成(剛突破) ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 60, "moonshot_n": 6, "pct": 10.0, "avg": 39.7}, 20: {"n": 60, "moonshot_n": 9, "pct": 15.0, "avg": 56.8} },
    "布林通道高檔(≥80%) ＋ 突破飆股大量黑K最高點剛形成 ＋ 晨星剛形成": { 20: {"n": 20, "moonshot_n": 3, "pct": 15.0, "avg": 67.6} },
    "KDJ近3日內黃金交叉 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 27, "moonshot_n": 3, "pct": 11.1, "avg": 35.1}, 20: {"n": 27, "moonshot_n": 4, "pct": 14.8, "avg": 71.8} },
    "MACD近3日內黃金交叉 ＋ 型態剛形成(剛突破) ＋ 夜星剛形成": { 20: {"n": 34, "moonshot_n": 5, "pct": 14.7, "avg": 59.8} },
    "MACD近3日內黃金交叉 ＋ 型態突破確認 ＋ 夜星剛形成": { 20: {"n": 34, "moonshot_n": 5, "pct": 14.7, "avg": 59.8} },
    "MACD近3日內黃金交叉 ＋ 夜星剛形成": { 20: {"n": 34, "moonshot_n": 5, "pct": 14.7, "avg": 59.8} },
    "MACD近3日內黃金交叉 ＋ 型態成形中 ＋ 夜星剛形成": { 20: {"n": 34, "moonshot_n": 5, "pct": 14.7, "avg": 59.8} },
    "突破飆股大量黑K最高點剛形成 ＋ 晨星剛形成": { 20: {"n": 21, "moonshot_n": 3, "pct": 14.3, "avg": 67.6} },
    "型態成形中 ＋ 突破飆股大量黑K最高點剛形成 ＋ 晨星剛形成": { 20: {"n": 21, "moonshot_n": 3, "pct": 14.3, "avg": 67.6} },
    "三大法人近3月賣超 ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 27, "moonshot_n": 3, "pct": 11.1, "avg": 37.9} },
    "多方力道≥80 ＋ 三大法人近3月買超 ＋ 夜星剛形成": { 10: {"n": 46, "moonshot_n": 5, "pct": 10.9, "avg": 43.4} },
    "MACD近3日內黃金交叉 ＋ 三重底剛形成 ＋ 圓弧底剛形成": { 10: {"n": 37, "moonshot_n": 4, "pct": 10.8, "avg": 44.2} },
    "多方力道≥65 ＋ 母子懷抱(高檔)剛形成 ＋ 夜星剛形成": { 10: {"n": 29, "moonshot_n": 3, "pct": 10.3, "avg": 44.8} },
    "強勢突破盤 ＋ 複式頭肩底剛形成 ＋ 圓弧底剛形成": { 10: {"n": 20, "moonshot_n": 2, "pct": 10.0, "avg": 38.0} },
    "近3月乖離度為負(股價超前營收) ＋ 圓弧底剛形成 ＋ 突破飆股大量黑K最高點剛形成": { 10: {"n": 31, "moonshot_n": 3, "pct": 9.7, "avg": 37.9} },
    "型態剛形成(剛突破) ＋ 突破ABC修正下降切線剛形成 ＋ 晨星剛形成": { 5: {"n": 21, "moonshot_n": 1, "pct": 4.8, "avg": 34.0}, 10: {"n": 21, "moonshot_n": 2, "pct": 9.5, "avg": 52.7} },
    "近3月乖離度為正(營收優於股價) ＋ N字底剛形成 ＋ 圓弧底剛形成": { 10: {"n": 21, "moonshot_n": 2, "pct": 9.5, "avg": 41.4} },
    "KDJ近3日內黃金交叉 ＋ 複式頭肩底剛形成 ＋ 圓弧底剛形成": { 10: {"n": 21, "moonshot_n": 2, "pct": 9.5, "avg": 38.0} },
    "KDJ近3日內死亡交叉 ＋ 回後買上漲全通過 ＋ 晨星剛形成": { 5: {"n": 24, "moonshot_n": 2, "pct": 8.3, "avg": 37.7} },
    "三大法人近3月買超 ＋ 一字底(均線糾結)剛形成 ＋ 突破ABC修正下降切線剛形成": { 5: {"n": 31, "moonshot_n": 2, "pct": 6.5, "avg": 35.8} },
    "KDJ近3日內黃金交叉 ＋ 回後買上漲全通過 ＋ 晨星剛形成": { 5: {"n": 32, "moonshot_n": 2, "pct": 6.2, "avg": 37.7} },
    "多方力道≥80 ＋ 近3月乖離度為負(股價超前營收) ＋ 晨星剛形成": { 5: {"n": 34, "moonshot_n": 2, "pct": 5.9, "avg": 32.8} },
    "多方力道≥65 ＋ 回後買上漲全通過 ＋ 晨星剛形成": { 5: {"n": 35, "moonshot_n": 2, "pct": 5.7, "avg": 37.7} },
    "KDJ近3日內黃金交叉 ＋ 一字底(均線糾結)剛形成 ＋ 突破ABC修正下降切線剛形成": { 5: {"n": 35, "moonshot_n": 2, "pct": 5.7, "avg": 35.8} },
    "MACD近3日內黃金交叉 ＋ 三重底剛形成 ＋ K線橫盤的突破剛形成": { 5: {"n": 74, "moonshot_n": 4, "pct": 5.4, "avg": 33.1} },
    "多方力道≥80 ＋ 近3月均價YoY為正 ＋ 晨星剛形成": { 5: {"n": 37, "moonshot_n": 2, "pct": 5.4, "avg": 32.8} },
    "多方力道≥80 ＋ KDJ近3日內死亡交叉 ＋ 突破ABC修正下降切線剛形成": { 5: {"n": 20, "moonshot_n": 1, "pct": 5.0, "avg": 34.0} },
    "一字底(均線糾結)剛形成 ＋ 突破ABC修正下降切線剛形成 ＋ K線橫盤的突破剛形成": { 5: {"n": 20, "moonshot_n": 1, "pct": 5.0, "avg": 32.6} },
    "布林通道高檔(≥80%) ＋ 近3月均價YoY為正 ＋ 夜星剛形成": { 5: {"n": 20, "moonshot_n": 1, "pct": 5.0, "avg": 33.1} },
    "MACD近3日內黃金交叉 ＋ KDJ近3日內死亡交叉 ＋ 三重底剛形成": { 5: {"n": 40, "moonshot_n": 2, "pct": 5.0, "avg": 35.7} },
    "MACD近3日內黃金交叉 ＋ KDJ近3日內死亡交叉 ＋ 回後買上漲全通過": { 5: {"n": 60, "moonshot_n": 3, "pct": 5.0, "avg": 41.2} },
    "多方力道≥80 ＋ 近3月均價YoY為正 ＋ 夜星剛形成": { 5: {"n": 41, "moonshot_n": 2, "pct": 4.9, "avg": 32.2} },
    "型態突破確認 ＋ 突破ABC修正下降切線剛形成 ＋ 晨星剛形成": { 5: {"n": 21, "moonshot_n": 1, "pct": 4.8, "avg": 34.0} },
